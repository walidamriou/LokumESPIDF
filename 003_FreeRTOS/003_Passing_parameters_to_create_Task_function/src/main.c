...
// we will pass "Task 1" string to Task_1 function
static const char* text_output_task1="Task 1";
...
void app_main() {
    ...
    xTaskCreate(&task_1, // pointer to the task function
                ...
                2048, // Stack depth 
                (void*)text_output_task1, // We pass parameters from main to the task function
                1, // priority 1
